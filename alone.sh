...
tar -zxvf titan_v0.1.16_linux_amd64.tar.gz

# 等待10秒
sleep 10

# 赋予执行权限
chmod u+x titan_v0.1.16_linux_amd64
...
tmux new -s titan_bind -d "cd titan_v0.1.16_linux_amd64 && ./titan-edge bind --hash=369BF4FD-0A3F-4EEF-B280-CE7A9C527907 https://api-test1.container1.titannet.io/api/v2/device/binding"
